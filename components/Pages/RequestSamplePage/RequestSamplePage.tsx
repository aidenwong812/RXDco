...
const RequestSamplePage = () => {
  ...
  return (
    <Layout type="single">
      ...
      />
      <Form
        className="px-[16px] py-[40px] md:px-[100px] md:py-[80px] rounded-[24px] bg-lightgray mt-[24px]
        relative z-[5]"
      ...
      >
        ...
        pb-[16px] md:pb-0 tracking-[-0.8px]"
        >
          Request a sample
        </p>
        <p className="px-[10px] md:px-0 text-[16px] font-radikal_light text-darkgray pb-[48px] text-center">
