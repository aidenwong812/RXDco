...
const LookInside = ({ toggleVisible }) => {
    ...
    <div className="relative">
      ...
      <div
        className="rounded-[0.5rem] bg-white 
          ...
          relative max-w-[461px] max-h-[90vh] overflow-y-auto"
      >
        ...
        <p className="text-brown text-[20px] tracking-[-0.4px] mb-[24px] leading-[1.4] font-radikal_light">
          {selected3DObject.insideDescription}
        </p>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={selected3DObject.inside} alt="not found inside." className="w-auto h-auto" />
        <div
